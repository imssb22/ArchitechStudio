      ...
      <header className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 py-24 lg:py-32 relative z-10 text-center">
          ...
          <div className="mt-10 flex justify-center space-x-6">
            <a
              href="/signup"
              className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl transition-transform hover:scale-105 animate-slide-in"
            >
              Sign Up
            </a>
            <a
              href="/signin"
              className="border-2 border-amber-500 text-amber-500 hover:bg-amber-100 px-8 py-4 rounded-full text-lg font-semibold transition-transform hover:scale-105 animate-slide-in"
            >
              Sign In
            </a>
          </div>
